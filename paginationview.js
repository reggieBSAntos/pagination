export default class PaginationButtons {
  ...
  _generateMarkup() {
    ...
    return `
      <button type="button" class="page-btn start-page" ${start()}>start</button>
      <button type="button" class="page-btn prev-page" ${prev()}>prev</button>
      ${this.pages
        .map((page) => {
          console.log();
          return ` 
        ...
        .join("")}
      <button type="button" class="page-btn next-page" ${next()}>next</button>
      <button type="button" class="page-btn end-page" ${end()}>end</button>
    `;
  }
